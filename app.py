...
if menu == "Excel Analysis":
    ...
    if uploaded_file is None:
        ...
        # ✅ FIXED NUMERIC CONVERSION (NO ERROR)
        ...
        try:
            ...
            st.warning("⚠️ Insight generation failed")
        ...
        try:
            ...
            st.warning("⚠️ Recommendation failed")

        # =======================
        # 💬 AI CHAT
        # =======================
        st.subheader("💬 AI Business Chat")
